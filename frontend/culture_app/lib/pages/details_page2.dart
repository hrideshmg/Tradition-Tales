    ...
    return Scaffold(
      ...
      body: InkWell(
        ...
        child: Stack(fit: StackFit.expand, children: [
          Opacity(
            opacity: 0.5,
            child: Image.asset("assets/images/theyyam_cover.jpg",fit:BoxFit.cover,
                 ),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    SizedBox(width: 5),
                        Flexible(child: Text("Theyyam is a vibrant and captivating ritual art form from North Kerala, India. It blends dance, mime, and music into a powerful performance that honors deities and spirits. Known for its elaborate costumes and towering headpieces, Theyyam is not just entertainment; it's believed to be a conduit to the divine, seeking blessings and maintaining harmony with the spiritual world.  These performances typically take place at temples and sacred groves during festivals, filling the air with the rhythmic beats of drums and the colorful spectacle of the Theyyam costumes.",style: TextStyle(color: Colors.white,fontSize: 18),))
                 , ],
                ),
                SizedBox(height: 50,),
        ...
        return Card(
          ...
          child: ListView(
            ...
            BorderRadius.circular(10),
              child: Image.asset("assets/images/theyyam1.jpg",width: 200,height: 200,)),
                SizedBox(),
                 Image.asset("assets/images/THEYYAM1-modified.png",width: 200,height: 200,),
                 SizedBox(),
                  Image.asset("assets/images/theyyam2.jpg",width: 200,height: 200,)
              ],),)), 
