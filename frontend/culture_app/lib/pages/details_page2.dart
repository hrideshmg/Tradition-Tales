      ...
      body: InkWell(
        child: Stack(fit: StackFit.expand, children: [
          Opacity(
            opacity: 0.5,
            child: Image.asset(
              "assets/images/theyyam_cover.jpg",
              fit: BoxFit.cover,
            ),
          ),
          Padding(
                    ...
                    child: Row(
                      children: [
                        ClipRRect(
                            ...
                            child: Image.asset(
                              "assets/images/theyyam1.jpg",
                              width: 200,
                              height: 200,
                            )),
                        SizedBox(),
                        Image.asset(
                          "assets/images/THEYYAM1-modified.png",
                          width: 200,
                          height: 200,
                        ),
                        SizedBox(),
                        Image.asset(
                          "assets/images/theyyam2.jpg",
                          width: 200,
                          height: 200,
                        )
                      ],
